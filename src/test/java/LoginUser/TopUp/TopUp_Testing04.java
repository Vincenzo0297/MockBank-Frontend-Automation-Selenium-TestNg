...
public class TopUp_Testing04 {
    ...
    public void testFormFilling() {
        ...
        //select Amount
        WebElement selectAmount = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//div[contains(@class, 'quick-buttons')]/button[3]")));
        selectAmount.click();
